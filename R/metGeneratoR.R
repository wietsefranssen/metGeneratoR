...
#'   shortwave  = list(ncname = "rsds",    filename = metGen$internal$ncFileNameShortwave),
#'   longwave   = list(ncname = "rlds",    filename = metGen$internal$ncFileNameLongwave),
...
#' mgsetOutVars(c("tas", "pr", "wind", "vp", "pressure", "shortwave", "longwave"))
#' 
