...
RcppExport SEXP _metGeneratoR_calc_tas_cr(SEXP tmin_hour_mapSEXP, SEXP tmax_hour_mapSEXP, SEXP tmin_mapSEXP, SEXP tmax_mapSEXP, SEXP ydaySEXP, SEXP nrecSEXP, SEXP xyboxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type tmin_hour_map(tmin_hour_mapSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type tmax_hour_map(tmax_hour_mapSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(calc_tas_cr(tmin_hour_map, tmax_hour_map, tmin_map, tmax_map, yday, nrec, xybox));
    return rcpp_result_gen;
END_RCPP
}
// rad_map_final_cr
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_metGeneratoR_calc_tas_cr", (DL_FUNC) &_metGeneratoR_calc_tas_cr, 7},
